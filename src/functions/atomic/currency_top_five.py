    ...
    def set_handlers(self, bot):
        ...
        def handle_currencyrate(message: Message):
            ...
            try:
                ...
                message_text = "🟢 EUR: Евро - валюта Европейского союза, используется в 19 из 27 стран ЕС.\n🟠 JPY: Японская иена - валюта Японии, одна из самых торгуемых валют в мире.\n🔴 GBP: Британский фунт - валюта Великобритании, одна из старейших валют в мире.\n⚫ AUD: Австралийский доллар - валюта Австралии, популярная в торговле сырьевыми товарами.\n🟤 CAD: Канадский доллар - валюта Канады, часто используется в торговле нефтью."
                bot.send_message(message.chat.id, message_text)
